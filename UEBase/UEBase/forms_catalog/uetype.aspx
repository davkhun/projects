<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uetype.aspx.cs" Inherits="UEBase.uetype" MasterPageFile="~/UE.Master"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:SqlDataSource ID="MSQLData" runat="server"
        ...
        SelectCommand="SELECT id,value FROM ue_type ORDER BY value ASC" />
